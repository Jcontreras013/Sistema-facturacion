...
- **Reportes (solo administradores):** ventas por período, productos más vendidos, ganancias, stock bajo, productos por vencer, flujo de caja, e ISV por tasa (15%/18%) neto de notas de crédito del período — pensado como insumo directo para la declaración mensual de ISV ante el SAR (no incluye crédito fiscal de compras a proveedores, ya que el sistema no lleva ese detalle).
