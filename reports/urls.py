...
urlpatterns = [
    ...
    path("lotes-por-vencer/", views.batch_expiration_report, name="batch_expiration_report"),
    ...
    path("cuentas-por-pagar/", views.accounts_payable_report, name="accounts_payable_report"),
]
