...
urlpatterns = [
    ...
    path("cotizaciones/nueva/", views.quote_create, name="quote_create"),
    path("cotizaciones/<int:pk>/", views.quote_detail, name="quote_detail"),
    path("cotizaciones/<int:pk>/agregar-producto/", views.quote_add_item, name="quote_add_item"),
    path("cotizaciones/<int:pk>/quitar-producto/<int:item_pk>/", views.quote_remove_item, name="quote_remove_item"),
    path("cotizaciones/<int:pk>/enviar/", views.quote_send, name="quote_send"),
    path("cotizaciones/<int:pk>/cancelar/", views.quote_cancel, name="quote_cancel"),
    path("cotizaciones/<int:pk>/eliminar/", views.quote_delete, name="quote_delete"),
    path("cotizaciones/<int:pk>/convertir/", views.quote_convert, name="quote_convert"),
